        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AppointmentName = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanyAddress = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: false),
                    DateCreated = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DateUpdated = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("PhoneNumber", "LEN(PhoneNumber) = 13 AND PhoneNumber NOT LIKE '%[^0-9]%'");
                    table.CheckConstraint("Salary", "Salary>0 AND Salary<200000");
                    table.ForeignKey(
